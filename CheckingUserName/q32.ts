...
let current_users: string [] = ["Azma", "Sarosh", "Sameed", "Safaan", "Salaar"]
let new_users: string[] = ["AzMA", "Sarosh", "Bob", "Eric", "John"]

// yeh one by one new_ users say ek ek ker k naam lai ga aur new _user mein save karay ga kaam karay ga us per
